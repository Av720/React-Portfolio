        ...
        <div className="footer" >
            <footer id="footer">
                ...
                <div className="icons-div"> 
                    ...
                    <a href="https://github.com/Av720"><i className="icons fa-brands fa-github fa-xl"></i></a>
                    <a href="https://www.linkedin.com/in/aldo-valencia-95b250237/"><i className="icons fa-brands fa-linkedin fa-xl"></i></a>
                </div>
            </footer>
